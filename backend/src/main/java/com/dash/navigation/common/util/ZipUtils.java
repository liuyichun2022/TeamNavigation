...
import com.dash.navigation.common.exception.UnzipException;
...
public class ZipUtils {
    ...
    public static void unzip(String id, String zipPath) {
        try (ZipFile zipFile = new ZipFile(TeamNavConstants.ROOT_DIR + zipPath)) {
            ...
            String savePath = StringExtUtils.format("{}/ext-resources/modules/{}/", TeamNavConstants.ROOT_DIR, id);
